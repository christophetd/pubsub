 ...
 *
 */
public class Task4_1 extends Task{
	
	public Task4_1(String host, int port, ArrayList<String> topics, ArrayList<String> msgs, CyclicBarrier barrier){
	...
	public void run() {
		...
		InputSequenceChecker seqChecker=new InputSequenceChecker(this.input,4);
